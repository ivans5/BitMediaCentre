...
//XXX
const char * MyTChDirDialog::changeDirTitle = "Change Directory";
const char * MyTChDirDialog::dirNameText = "Directory ~n~ame";
const char * MyTChDirDialog::dirTreeText = "Directory ~t~ree";
const char * MyTChDirDialog::okText = "O~K~";
const char * MyTChDirDialog::chdirText = "~C~hdir";
const char * MyTChDirDialog::revertText = "~R~evert";
const char * MyTChDirDialog::helpText = "Help";
const char * MyTChDirDialog::drivesText = "Drives";
const char * MyTChDirDialog::invalidText = "Invalid directory";
...
char TDeskTop::defaultBkgrnd = 127; ///XXX - transparent background
