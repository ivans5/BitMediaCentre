 ...
 * directories stored in a TDirCollection object
 */
class MyTDirListBox : public TListBox
{
public:
   /**
    * Calls TListBox::TListBox(bounds, 1, aScrollBar) to create a
...
//    virtual void handleEvent( TEvent& );
     ...
     * associated with this directory list box.
     */
    virtual void doUpdate(); //XXX - re-scan directory, checking for updates, then update the UI...
...
//protected:
     ...
     * Undocumented.
     */
    MyTDirListBox( StreamableInit ): TListBox( streamableInit ) {}
//public:
    /**
     * Undocumented.
     */
 ...
 * Undocumented.
 */
inline ipstream& operator >> ( ipstream& is, MyTDirListBox& cl )
    { return is >> (TStreamable&)cl; }
/**
 * Undocumented.
 */
 ...
 * Undocumented.
 */
inline opstream& operator << ( opstream& os, MyTDirListBox& cl )
    { return os << (TStreamable&)cl; }
/**
 * Undocumented.
 */
...
inline TDirCollection *MyTDirListBox::list()
{
    return (TDirCollection *)TListBox::list();
}
/* END XXX */
...
private:
    ...
    virtual const char *streamableName() const
        { return name; }
protected:
    MyTChDirDialog( StreamableInit ) : TDialog( streamableInit ),
...
inline ipstream& operator >> ( ipstream& is, MyTChDirDialog& cl )
    { return is >> (TStreamable&)cl; }
inline ipstream& operator >> ( ipstream& is, MyTChDirDialog*& cl )
    { return is >> (void *&)cl; }
inline opstream& operator << ( opstream& os, MyTChDirDialog& cl )
    { return os << (TStreamable&)cl; }
inline opstream& operator << ( opstream& os, MyTChDirDialog* cl )
    { return os << (TStreamable *)cl; }
