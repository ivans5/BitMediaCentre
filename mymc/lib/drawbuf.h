...
public:
    ...
    //XXX-rewrite this to upgrade 'c' to a string and continue to fill as normal...
    ...
    //XXX-iterate thru the chars of str, making a 2-byte string at that position of the data buff, discard attribute data for now...
    //
    /**
     * Writes a string in the buffer.
     *
    ...
    //XXX- upgrade to string and install it...
protected:
    /**
     * Defines the array for this draw buffer.
     */
    //XXX - change this to array of char[4]
...
//XXX - change this to support wide char
